...
public class Student extends Person{
    ...
    @Column(name = "scholarship amount")
    private Double scholarshipAmount;

    public Student() {
    }

    public Student(String firstName, String lastName, String pesel, Double height, Double weight, String emailAddress, String universityName, Integer yearOfStudy, String fieldOfStudy, Double scholarshipAmount) {
    ...
    public Student(Long id, String firstName, String lastName, String pesel, Double height, Double weight, String emailAddress, String universityName, Integer yearOfStudy, String fieldOfStudy, Double scholarshipAmount) {
